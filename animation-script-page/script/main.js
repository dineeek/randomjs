...
const animationTimeline = () => {
  ...
  const chatBoxChars = document.getElementsByClassName("hbd-chatbox")[0];

  chatBoxChars.innerHTML = `<span>${chatBoxChars.innerHTML
    .split("")
    .join("</span><span>")}</span`;
  ...
  const replyBtn = document.getElementById("replayButton");
